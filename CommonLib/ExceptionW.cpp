...
ExceptionW::ExceptionW(LPCTSTR msg, LPCSTR fileName, int lineNumber)
	: m_fileName(fileName), m_lineNumber(lineNumber), m_message(msg)
{
}

ExceptionW::ExceptionW(LPCSTR fileName, int lineNumber, LPCTSTR fmtStr, ...)
...
const wchar_t* ExceptionW::message() const
{
